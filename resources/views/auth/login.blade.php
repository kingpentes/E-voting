        ...
        <div class="min-h-screen flex">
            ...
            <div class="w-full lg:w-3/5 flex items-center justify-center p-6 lg:p-12">
                <div class="w-full max-w-md">
                    ...
                    @endif
                    @if (session('info'))
                        <div class="mb-4 text-sm text-blue-600">{{ session('info') }}</div>
                    @endif
                    @if (session('success'))
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                @if (Route::has('password.request'))
                                    <a href="{{ route('password.request') }}"
                                        class="text-sm font-medium text-blue-600 hover:text-blue-500 transition duration-200 hover:underline">
                                        Forgot password?
                                    </a>
                                @endif
                            </div>
                            ...
                            <div class="text-center pt-4 border-t border-gray-100">
                                <p class="text-sm text-gray-600">
                                    ...
                                    <a href="{{ route('register') }}"
                                        class="font-semibold text-blue-600 hover:text-blue-500 transition duration-200 hover:underline">
                                        Create one here
                                    </a>
                                </p>
                            </div>
