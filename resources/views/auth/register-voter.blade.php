...
<body class="font-sans text-gray-900 antialiased">
    <div class="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50">
        <div class="min-h-screen flex">
            ...
            <div
                class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-purple-600 via-pink-600 to-purple-800 relative overflow-hidden">
                ...
                <div
                    class="relative z-10 flex flex-col justify-center items-center text-center text-white p-12 max-w-2xl mx-auto">
                    <div class="mb-8">
                ...
                <div class="w-full max-w-lg">
                    ...
                    <div class="mb-8">
                        <div class="flex lg:hidden justify-center mb-6">
                            <div
                                class="w-16 h-16 bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl flex items-center justify-center shadow-lg">
                    ...
                    <div class="bg-white/80 backdrop-blur-sm shadow-xl rounded-2xl p-8 border border-white/20">
                        <form method="POST" action="{{ route('register.voter.store') }}" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                <div class="mb-4 bg-purple-50 border border-purple-200 rounded-lg p-4">
                                    <p class="text-sm text-purple-800">
                                        <strong>Note:</strong> After registration, you'll be able to complete ID
                                        verification and face scan from your voter dashboard.
                                    </p>
                                </div>
                            ...
                            <div class="pt-6">
                                <button type="submit"
                                    class="w-full bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-semibold py-3 px-6 rounded-xl hover:from-blue-700 hover:to-cyan-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transform transition duration-200 hover:scale-[1.02] active:scale-[0.98] shadow-lg hover:shadow-xl">
                            ...
                            <div class="text-center pt-6 border-t border-gray-100 space-y-2">
                                <p class="text-gray-600">
                                    ...
                                    <a href="{{ route('register.organizer') }}"
                                        class="font-semibold text-purple-600 hover:text-purple-500 transition duration-200 hover:underline">
                                        Click here
                                    </a>
                                </p>
