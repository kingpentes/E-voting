...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased">
        <div class="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-indigo-50">
            <div class="min-h-screen flex">
                <!-- Left Side - Hero Section -->
                <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-b from-indigo-900 via-purple-900 to-indigo-900 relative overflow-hidden">
                    ...
                    <div class="relative z-10 flex flex-col justify-center items-center text-center text-white p-12 max-w-2xl mx-auto">
                        <div class="mb-8">
                            ...
                            <p class="text-xl text-indigo-200 leading-relaxed max-w-md">
                        ...
                        <div class="space-y-4 text-left w-full max-w-sm">
                            <div class="flex items-center space-x-3">
                                ...
                                <span class="text-indigo-200">Biometric verification</span>
                            </div>
                            <div class="flex items-center space-x-3">
                                <div class="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <span class="text-indigo-200">ID card validation</span>
                            </div>
                            <div class="flex items-center space-x-3">
                                <div class="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <span class="text-indigo-200">Anonymous ballot casting</span>
                            </div>
                            <div class="flex items-center space-x-3">
                                <div class="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <span class="text-indigo-200">Invitation-based access</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="w-full max-w-lg">
                        ...
                        <div class="mb-8">
                            <div class="flex lg:hidden justify-center mb-6">
                                <div class="w-16 h-16 bg-gradient-to-br from-indigo-700 to-purple-800 rounded-2xl flex items-center justify-center shadow-lg">
                        ...
                        <div class="bg-white/80 backdrop-blur-sm shadow-xl rounded-2xl p-8 border border-white/20">
                            <form method="POST" action="{{ route('register.voter.store') }}" class="space-y-6">
                                ...
                                <div class="grid grid-cols-1 gap-6">
                                    <div class="mb-4 bg-indigo-50 border-l-4 border-indigo-700 rounded-lg p-4">
                                    ...
                                    <div class="group">
                                        ...
                                        <input 
                                            ...
                                            required 
                                            autocomplete="name"
                                            class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-purple-700 focus:border-transparent transition duration-200 bg-gray-50 focus:bg-white group-hover:bg-white placeholder-gray-400"
                                ...
                                <div class="pt-6">
                                    <button 
                                        type="submit"
                                        class="w-full bg-gradient-to-r from-indigo-700 to-purple-800 text-white font-semibold py-3 px-6 rounded-xl hover:from-indigo-800 hover:to-purple-900 focus:outline-none focus:ring-2 focus:ring-purple-700 focus:ring-offset-2 transform transition duration-200 hover:scale-[1.02] active:scale-[0.98] shadow-lg hover:shadow-xl"
                                    >
                                ...
                                <div class="text-center pt-6 border-t border-gray-100 space-y-2">
                                    <p class="text-gray-600">
                                        ...
                                        <a href="{{ route('register.organizer') }}" class="font-semibold text-indigo-700 hover:text-purple-800 transition duration-200 hover:underline">
                                            Click here
                                        </a>
                                    </p>
                                    <p class="text-sm text-gray-500">
                                        Already have an account? 
                                        <a href="{{ route('login') }}" class="font-semibold text-indigo-700 hover:text-purple-800 transition duration-200 hover:underline">
                                            Sign in here
                                        </a>
                                    </p>
                                </div>
