...
<nav
    class="{{ $transparent ? 'bg-transparent' : 'bg-gradient-to-r from-blue-900 via-cyan-900 to-blue-900' }} text-white shadow-lg sticky top-0 z-50 backdrop-blur-sm">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            <!-- Logo & Brand -->
            <div class="flex items-center space-x-3">
                <div
                    class="w-10 h-10 {{ $transparent ? 'bg-blue-600/80' : 'bg-white/20' }} rounded-lg flex items-center justify-center backdrop-blur-sm">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                </div>
                <a href="/" class="font-bold text-2xl hover:text-blue-100 transition">
                    E-Voting System
                </a>
            </div>
            ...
            <div class="flex items-center space-x-6">
                @auth
                    ...
                    <div class="flex items-center space-x-4 bg-white/10 backdrop-blur-md rounded-xl px-4 py-2">
                        <div class="flex items-center space-x-3">
                            <div
                                class="w-10 h-10 bg-gradient-to-br from-blue-500 to-cyan-600 rounded-full flex items-center justify-center font-bold text-white shadow-lg">
                ...
                @else
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <a href="{{ route('register') }}"
                            class="flex items-center space-x-2 px-6 py-2.5 bg-white text-blue-600 hover:bg-blue-50 rounded-lg transition duration-200 font-semibold shadow-lg transform hover:scale-105">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
