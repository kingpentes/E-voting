...
<nav
    class="{{ $transparent ? 'bg-transparent' : 'bg-gradient-to-r from-indigo-900 via-purple-900 to-indigo-900' }} text-white shadow-lg sticky top-0 z-50 backdrop-blur-sm">
    <div class="container mx-auto px-6 py-4">
        <div class="flex items-center justify-between">
            <!-- Logo & Brand -->
            <div class="flex items-center space-x-3">
                <div
                    class="w-10 h-10 {{ $transparent ? 'bg-indigo-600/80' : 'bg-white/20' }} rounded-lg flex items-center justify-center backdrop-blur-sm">
