                    ...
                    @auth
                        <div class="flex items-center space-x-4">
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <button type="submit"
                                    class="text-blue-100 hover:text-white font-semibold text-sm transition-colors">
                                    Logout
                                </button>
                            </form>
                        </div>
            ...
            @if ($election->status !== 'closed')
                <div class="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl shadow-lg p-6 mb-8 text-white">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                            ...
                            <p class="text-2xl font-bold">
                                {{ \Carbon\Carbon::parse($election->start_date)->format('d M Y') }}</p>
                        ...
                        <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                            <div class="flex items-center mb-2">
                                <svg class="w-5 h-5 mr-2 text-red-300" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg>
                    ...
                    @php
                        ...
                        $startDate =
                            $election->start_date instanceof \Carbon\Carbon
                        ...
                        $endDate =
                            $election->end_date instanceof \Carbon\Carbon
                    ...
                    <ol class="space-y-3">
                        @foreach ($election->rules as $rule)
                            <li class="flex items-start">
                                <span
                                    class="flex-shrink-0 w-8 h-8 bg-blue-100 text-blue-700 rounded-full flex items-center justify-center font-bold text-sm mr-3">
                                    {{ $loop->iteration }}
                                </span>
                        ...
                        <div class="p-6">
                            <div class="flex flex-col items-center text-center">
                                <div class="relative mb-4">
                                    ...
                                    <span
                                        class="absolute -bottom-2 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-sm font-bold px-4 py-1 rounded-full shadow-lg">
                                        #{{ $candidate->number }}
                                    </span>
                                </div>
                                <h3
                            ...
                            <div class="mt-4 pt-4 border-t border-gray-100">
                                ...
                                <div class="flex items-center justify-between text-sm">
                                    ...
                                    <span
                                        class="text-blue-600 font-semibold group-hover:text-blue-700 flex items-center">
                                        Lihat Detail
